                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <p style={{ fontSize: '7pt', fontWeight: 'bold', margin: 0, color: '#365992', lineHeight: 1.1 }}>If received in error, please delete it and notify the senders or&nbsp;<a href="https://forms.gle/dR5d8hG127kTiNWs8" target="_blank" rel="noopener noreferrer" style={{ color: '#C94749' }}>complaint</a>.</p><br/>
                        </td>
                    </tr>
                </tbody>
            </table>
